    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative bg-gradient-to-br from-slate-50 to-blue-50 py-20 lg:py-28 overflow-hidden">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl lg:text-5xl font-black font-[family-name:var(--font-montserrat)] text-slate-800 mb-6">
            About <span className="text-blue-600">Harvest Lending Inc.</span>
          </h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <h3 className="text-3xl font-bold font-[family-name:var(--font-montserrat)] text-slate-800 mb-6 text-center">
            Our Mission
          </h3>
          <div className="space-y-4 text-slate-600 font-[family-name:var(--font-open-sans)] text-lg leading-relaxed">
            <p>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="space-y-4 text-slate-600 font-[family-name:var(--font-open-sans)] text-lg leading-relaxed text-center">
            <p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h3 className="text-3xl font-bold font-[family-name:var(--font-montserrat)] text-slate-800 mb-12 text-center">
            What Sets Us Apart
          </h3>
              ...
              >
                <CardContent className="pt-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-bold text-slate-800 mb-2 font-[family-name:var(--font-montserrat)]">
                        {title}
                      </h4>
                      <p className="text-slate-600 font-[family-name:var(--font-open-sans)] leading-relaxed">
                        {description}
                      </p>
                    </div>
                  </div>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-10 items-start max-w-6xl mx-auto">
            <h3 className="text-4xl lg:text-5xl font-black font-[family-name:var(--font-montserrat)] text-slate-800 leading-tight lg:sticky lg:top-28">
              The money itself is <span className="text-blue-600">personal.</span>
            </h3>
            <div className="space-y-4 text-slate-600 font-[family-name:var(--font-open-sans)] text-lg leading-relaxed">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <h3 className="text-3xl font-bold font-[family-name:var(--font-montserrat)] text-slate-800 mb-6">
            Building Long-Term Partnerships
          </h3>
          <p className="text-slate-600 font-[family-name:var(--font-open-sans)] text-lg leading-relaxed">
      ...
      <section className="py-16 bg-slate-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-slate-300 font-[family-name:var(--font-open-sans)] mb-8 max-w-2xl mx-auto">
